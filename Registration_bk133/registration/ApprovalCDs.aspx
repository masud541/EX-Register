<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageRA.master" AutoEventWireup="true" CodeFile="ApprovalCDs.aspx.cs" Inherits="ApprovalCDs" MaintainScrollPositionOnPostback="true"%>
        ...
        <tr>
            <td style="text-align: center">
                <asp:Label ID="Label3" runat="server" style="font-weight: 700" 
                    Text="APPROVAL CODES"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label4" runat="server" style="font-weight: 700" 
                    Text="Add Approval Code"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="style1" style="width: 8%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="LabelApprovalCDInsertError" runat="server" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label7" runat="server" style="font-weight: 700" 
                    Text="Existing Approval Codes"></asp:Label>
            &nbsp;
                <asp:Label ID="LabelApprovalCDError" runat="server" ForeColor="Red"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    CellPadding="4" DataKeyNames="APPROVAL_CD_SEQ" DataSourceID="ObjectDataSource1" 
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    DeleteMethod="DeleteApprovalCD" OldValuesParameterFormatString="original_{0}" 
                    SelectMethod="SelectApprovalCDs" TypeName="RABusinessObject" 
                    UpdateMethod="UpdateApprovalCD">
                    <DeleteParameters>
                        <asp:Parameter Name="original_APPROVAL_CD_SEQ" Type="Int32" />
                    </DeleteParameters>
                    <UpdateParameters>
