<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageRA.master" AutoEventWireup="true" CodeFile="RequestRaCS.aspx.cs" Inherits="RequestRaCS"  MaintainScrollPositionOnPostback="true"%>
    ...
    <table class="style1">
        ...
        <tr>
            <td class="style12" valign="top" colspan="8">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource7" runat="server" 
                    OldValuesParameterFormatString="original_{0}" 
                    SelectMethod="SelectParentCustomerByUserID" TypeName="RABusinessObject">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownListDealerAndContact" Name="userid" 
        ...
        <tr>
            ...
            <td class="style8">
                <asp:CompareValidator ID="CompareValidator2" runat="server" 
                    ...
                    Operator="LessThan" Type="Date" ControlToCompare="TextBoxHiddenDate" 
                    CssClass="style32"></asp:CompareValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                    ControlToValidate="TextBoxPurchaseDate" ErrorMessage="Invalid Format" 
                    Operator="DataTypeCheck" Type="Date" CssClass="style32"></asp:CompareValidator>
            </td>
            <td align="right" class="style9" colspan="2">
                &nbsp;</td>
            <td class="style17">
        ...
        <tr valign="top">
            ...
            <td class="style19" colspan="2">
                <asp:Button ID="Button1" runat="server" Text="Submit RA Request" 
