...
public partial class MasterPage : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (Page.ToString() == "ASP.recallstartHD750_aspx")
        {
        }
        else if (Page.ToString() == "ASP.recallstartMHD750_aspx")
        {
        }
        ...
        else if (Page.ToString() == "ASP.recallstatuscheck_aspx")
        {
        }
        else if (Page.ToString() == "ASP.recallsearchresult_aspx")
        {
        }
